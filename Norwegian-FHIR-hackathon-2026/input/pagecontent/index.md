...
Join other healthcare informatics professionals and the Norwegian HL7 community for a day of learning, collaboration, and problem-solving. Discuss use cases, test ideas, share experiences, or dive into the technology with hands-on coding exercises.
...
The Norwegian FHIR hackathon is an in-person event.

* **Place:** Rebel in Oslo
* **Date:** November 9, 2026

Check the [Agenda](hack-agenda.html) page for detailed information.
...
The [FHIR 101 track](101-track.html) is dedicated to an introduction to FHIR.
